...
Usage:
  /plan-review                                 — review the lowest numbered plan in .personal/docs/plans/active/
  /plan-review .personal/docs/plans/active/0.4-auth.md   — review a plan file
  /plan-review "Add OAuth login with Google"   — review a plan described inline

Options:
  /plan-review --context .personal/docs/architecture/system-overview.md — provide extra context files
